    ...
    <nav aria-label="breadcrumb" class="breadcrumb-nav border-0 mb-0">
        <div class="container d-flex align-items-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{$getProduct->getCategory->slug}}">{{$getProduct->getCategory->name}}</a></li>
                    ...
                    <div class="col-md-6">
                        <div class="product-details">
                            ...
                            <div class="product-content">
                                <p>                                {{$getProduct->short_description}}
                                </p>
                    ...
                    <input type="hidden"  name="product_id" value="{{$getProduct->id}}">
                        @if(!empty($getProduct->getColor->count()))
                            ...
                            <div class="details-filter-row details-row-size">
                                ...
                                <div class="select-custom">
                                    <select name="size" id="size" class="form-control getSizePrice" required>
                            ...
                            <div class="product-details-footer">
                                <div class="product-cat">
                                    <span>Category:</span>
                                    <a href="{{$getProduct->getCategory->slug}}">{{$getProduct->getCategory->name}}</a>,
                                    <a href="{{$getProduct->getSubCategory->slug}}">{{$getProduct->getSubCategory->name}}</a>
