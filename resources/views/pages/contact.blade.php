                    ...
                    <form action="" class="contact-form mb-3" autocomplete="off" method="POST">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control" name="name" required id="cname" placeholder="Name *" required>
                            </div><!-- End .col-sm-6 -->

                            <div class="col-sm-6">
                                <label for="cemail" class="sr-only">Email</label>
                                <input type="email" class="form-control"  name="email" required id="cemail" placeholder="Email *" required>
                            </div><!-- End .col-sm-6 -->
                        </div><!-- End .row -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control" name="subject" required id="csubject" placeholder="Subject">
                            </div>
                        </div>
