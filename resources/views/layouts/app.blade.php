...
<body>
 ...
 @include('layouts._footer')
                ...
                <div class="row no-gutters bg-white newsletter-popup-content">
                    <div class="col-xl-3-5col col-lg-7 banner-content-wrap">
                        <div class="banner-content text-center">
                            <img src="{{url('front/assets/images/popup/newsletter/logo-black.svg')}}" class="logo" alt="logo" width="105" height="20">
                            <h2 class="banner-title">get <span>25<light>%</light></span> off</h2>
                            <p>Subscribe to the ARABICA E-Store newsletter to receive timely updates from your favorite products.</p>
                            <form action="#">
                    ...
                    <div class="col-xl-2-5col col-lg-5 ">
                        <img src="{{url('front/assets/images/popup/newsletter/img-1.jpg')}}" class="newsletter-img" alt="newsletter">
                    </div>
                </div>
            </div>
        </div>
    ...
    <script src="{{url('front/assets/js/wNumb.js')}}"></script>
