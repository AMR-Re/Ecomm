            ...
            <div class="col-md-12">
               ...
               <div class="card card-primary">
                  ...
                  <form  action="#" method="POST" >
                    ...
                    <div class="card-body">
                      <div class="form-group">
                        <label>sub_Category Name <span style="color: red">*</span></label>
                        <input type="name" class="form-control " name="name" required value="{{old('name')}}" placeholder="Enter sub-Category Name">
                      </div>
                      <div class="form-group">
                        <label>Slug <span style="color: red">*</span></label>
                        <input type="slug" class="form-control " name="slug" value="{{old('slug')}}"required placeholder="slug EX. URL">
